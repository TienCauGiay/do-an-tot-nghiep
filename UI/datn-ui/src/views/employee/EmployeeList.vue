  ...
  <div class="content-main-body">
    <div class="content-action">
      ...
      <div class="insert-data">
        <ms-button-default
          :textButtonDefault="this.$_MSResource[this.$_LANG_CODE].TEXT_CONTENT.ADD_EMPLOYEE"
...
export default {
  ...
  created() {
    ...
    this.$_MSEmitter.on("confirmYesDeleteEntity", async () => {
      await this.btnConfirmYesDeleteEmployee();
    });
    this.$_MSEmitter.on("confirmNoDeleteEntity", () => {
      this.btnConfirmNoDeleteEmployee();
    });
    this.$_MSEmitter.on("confirmYesDeleteMultiple", async () => {
  ...
  beforeUnmount() {
    ...
    this.$_MSEmitter.off("confirmYesDeleteEntity");
    this.$_MSEmitter.off("confirmNoDeleteEntity");
    this.$_MSEmitter.off("confirmYesDeleteMultiple");
