<template>
  ...
  <div class="content-main-body">
    ...
    <ms-dialog-confirm-delete
      ...
      }${subjectNameDeleteSelected}${this.$_MSResource[this.$_LANG_CODE].DIALOG.CONTENT.END}`"
...
export default {
  ...
  methods: {
    ...
    onDeleteSubject() {
      ...
      this.isOverlay = true;
      this.subjectIdDeleteMultiple = this.selectedSubject.subject_id;
    },
    /**
    ...
    async btnConfirmDeleteSubject() {
      try {
        this.isShowLoading = true;
        const res = await subjectService.delete(this.subjectIdDeleteMultiple);
        this.isShowLoading = false;
